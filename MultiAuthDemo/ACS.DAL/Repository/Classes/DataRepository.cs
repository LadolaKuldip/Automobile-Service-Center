...
namespace ACS.DAL.Repository.Classes
{
    public class DataRepository : IDataRepository
    {
        ...
        public IndexCounts GetAdminIndex()
        {
            ...
            indexCounts.count2 = _DbContext.Vehicles.Where(x => x.Customer.IsActive == true).Count();
        ...
        public IndexCounts GetDealerIndex(string userId)
        {
            ...
            indexCounts.count2 = _DbContext.Vehicles.Where(x => x.Customer.IsActive == true && x.Customer.Dealer.UserId == userId).Count();
